      ...
      <Suspense fallback={
        <div className="flex justify-center items-center py-16 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20">
          <div className="text-center">
            ...
            <p className="text-slate-700 text-lg font-medium">🎯 Cargando tus metas...</p>
            <p className="text-slate-500 text-sm mt-2">Preparando tu panel de progreso</p>
          </div>
        </div>
      }>
