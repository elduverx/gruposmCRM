  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className={`grid gap-6 ${news.length > 0 ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1'}`}>
          {/* Noticias - Siempre se muestra */}
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex justify-between items-center mb-4">
            ...
            <div className="space-y-4 max-h-[400px] overflow-y-auto">
              {news.length > 0 ? (
                ...
                <div className="text-center text-gray-500 py-8">
                  ...
                  <p className="font-medium">No hay noticias aún</p>
                  <p className="text-sm mt-1">Crea la primera noticia para desbloquear la sección de encargos</p>
                </div>
              )}
            </div>
          </div>

          {/* Encargos - Solo se muestra si hay al menos una noticia */}
          {news.length > 0 && (
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex justify-between items-center mb-4">
